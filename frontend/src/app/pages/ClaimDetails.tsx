  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Regulation Session */}
        <div className="bg-white dark:bg-[#151515] rounded-xl shadow-sm border border-gray-100 dark:border-[#222222] p-6 flex flex-col h-full">
          <div className="flex items-center mb-6 pb-4 border-b border-gray-100 dark:border-[#222222]">
        ...
        {/* Financial Session */}
        <div className="bg-white dark:bg-[#151515] rounded-xl shadow-sm border border-gray-100 dark:border-[#222222] p-6 flex flex-col h-full relative overflow-hidden">
          {/* Disabled Overlay if not ready */}
          {claim.status !== 'Aprovado' && claim.status !== 'Pago' && (
            <div className="absolute inset-0 bg-white/60 dark:bg-[#151515]/80 backdrop-blur-[1px] z-10 flex flex-col items-center justify-center border-l border-gray-100 dark:border-[#222222]">
              <div className="bg-white dark:bg-[#0a0a0a] p-4 rounded-lg shadow-md border border-gray-200 dark:border-[#222222] text-center max-w-[80%]">
