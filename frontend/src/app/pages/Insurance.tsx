    ...
    switch(status) {
      ...
      case "Vencida":
        return {
          ...
          border: `1px solid ${colors.brandRed}4D`
        };
      default:
        return {};
    }
                ...
                <tr key={index} className="border-b h-12 hover:bg-gray-50 dark:hover:bg-[#1A1F2E]" style={{ borderColor: colors.cardBorder }}>
                  ...
                  <td className="px-4 py-3" style={{ minWidth: '110px' }}>
                    <span
                      ...
                      style={getStatusBadgeStyle(policy.status)}
                    >
                      {policy.status}
                    </span>
                  </td>
          ...
          <div className="p-4 md:p-6 space-y-6">
            ...
            <div
              ...
              className={`border-2 border-dashed rounded-xl p-8 text-center transition-all cursor-pointer ${
                isDragging ? 'border-[#1c3d32] bg-[#1c3d32]/5' : 'border-gray-300 hover:border-[#1c3d32] hover:bg-gray-50 dark:hover:bg-[#1A1F2E]'
              }`}
            ...
            >
              ...
              <div className="flex flex-col items-center gap-4">
                <div className={`p-4 rounded-full transition-colors ${
                  isDragging ? 'bg-[#1c3d32]' : 'bg-gray-100'
                }`}>
                  <Upload className={`w-8 h-8 transition-colors ${
                    isDragging ? 'text-white' : 'text-gray-400 dark:text-[#64748B]'
                  }`} strokeWidth={1.5} />
                </div>
