  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="bg-white dark:bg-[#151515] rounded-xl shadow-sm border border-gray-100 dark:border-[#222222] p-8">
          <div className="border-b border-gray-100 dark:border-[#222222] pb-4 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select 
                ...
                className={`w-full border ${errors.store ? 'border-red-500' : 'border-gray-300 dark:border-[#222222]'} rounded-lg shadow-sm py-2.5 px-3 focus:ring-[#8B1A1A] focus:border-[#8B1A1A] bg-white dark:bg-[#1E2435] text-gray-900 dark:text-[#F1F5F9] text-sm`}
              >
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  className={`w-full border ${errors.date ? 'border-red-500' : 'border-gray-300 dark:border-[#222222]'} rounded-lg shadow-sm py-2.5 px-3 focus:ring-[#8B1A1A] focus:border-[#8B1A1A] bg-white dark:bg-[#1E2435] text-gray-900 dark:text-[#F1F5F9] text-sm`}
                />
              </div>
            ...
            <div>
              ...
              <select 
                ...
                className={`w-full border ${errors.type ? 'border-red-500' : 'border-gray-300 dark:border-[#222222]'} rounded-lg shadow-sm py-2.5 px-3 focus:ring-[#8B1A1A] focus:border-[#8B1A1A] bg-white dark:bg-[#1E2435] text-gray-900 dark:text-[#F1F5F9] text-sm`}
              >
                <option value="">Selecione...</option>
            ...
            <div>
              ...
              <select 
                {...register("riskClass")}
                className="w-full border border-gray-300 dark:border-[#222222] rounded-lg shadow-sm py-2.5 px-3 focus:ring-[#8B1A1A] focus:border-[#8B1A1A] bg-white dark:bg-[#1E2435] text-gray-900 dark:text-[#F1F5F9] text-sm"
              >
            ...
            <div className="md:col-span-2">
              ...
              <textarea 
                ...
                className={`w-full border ${errors.description ? 'border-red-500' : 'border-gray-300 dark:border-[#222222]'} rounded-lg shadow-sm p-3 focus:ring-[#8B1A1A] focus:border-[#8B1A1A] bg-white dark:bg-[#1E2435] text-gray-900 dark:text-[#F1F5F9] text-sm`}
              />
        ...
        <div className="bg-white dark:bg-[#151515] rounded-xl shadow-sm border border-gray-100 dark:border-[#222222] p-8">
          ...
          >
            ...
            <label className="cursor-pointer bg-white dark:bg-[#1E2435] border border-gray-300 dark:border-[#222222] text-gray-700 dark:text-[#F1F5F9] px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-50 dark:hover:bg-[#1f1f1f] transition-colors shadow-sm">
              Selecionar Arquivos
        ...
        <div className="flex items-center justify-end space-x-4 pt-4">
          <button 
            type="button"
            onClick={() => navigate(-1)}
            className="px-6 py-2.5 border border-gray-300 dark:border-[#222222] rounded-lg text-sm font-medium text-gray-700 dark:text-[#F1F5F9] bg-white dark:bg-[#151515] hover:bg-gray-50 dark:hover:bg-[#1f1f1f] shadow-sm transition-colors"
          >
            Cancelar
          </button>
          <button 
